...
```{r}
network <- readRDS("../networks/bact_prev_test/outputs/test_bact_prev70_single_rep_network.rds")
...
a <- ggnet2(net_test, node.size = 1, color = "#c6cdf7") + labs(title = "Fungal ASVs, 70% prevalence", subtitle = "Single rep.num")
