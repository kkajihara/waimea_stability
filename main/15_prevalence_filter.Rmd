...
fung_abun_prevfilter_on_empo <- fung_abun_prevfilter_on_empo[,colSums(fung_abun_prevfilter_on_empo)>0] #1954 ASVs, 1433 samples (original was 26308 ASVs, 1442 samples)
...
bact_habprev_asv_names <- unique(c(rownames(bact_prev_by_hab[[1]]), 
                                   ...
                                   rownames(bact_prev_by_hab[[3]]))) # 1499 ASVs
...
bact_abun_prevfilter_on_empo <- bact_abun_prevfilter_on_empo[,colSums(bact_abun_prevfilter_on_empo)>0] #14268 ASVs, 1464 samples (original was 159368 ASVs, 1464 samples)
