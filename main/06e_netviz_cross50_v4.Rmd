...
```{r}
network <- readRDS("../networks/prev50_finals/outputs/crossdom_mb_thresh01.rds")
...
a <- ggnet2(net_test, node.size = 1, color = "#c6cdf7") + labs(title = "Cross domain, 50% prevalence", subtitle = "Batch, nlambda = 20, thresh= 0.01")
