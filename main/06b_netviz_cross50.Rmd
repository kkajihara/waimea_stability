...
```{r}
network <- readRDS("../networks/bact_prev_test/outputs/batch_crossdom_test_prev50.rds")
...
a <- ggnet2(net_test, node.size = 1, color = "#c6cdf7") + labs(title = "Cross domain, 50% prevalence", subtitle = "Batch")
