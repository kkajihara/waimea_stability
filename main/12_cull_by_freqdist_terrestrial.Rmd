...
#saveRDS(fung_abun_terr_freq_culled, "../networks/input_data/full_fungi_top1000_asv_table.rds")

```

```{r}
## filter to one site
f_met_pc <- fung_met_terr[fung_met_terr$site_name=="Entrance",]
...
saveRDS(f_abun_pc, "../networks/input_data/fung_entrance_terr_top1000_allempos_in_site_entrance.rds")
