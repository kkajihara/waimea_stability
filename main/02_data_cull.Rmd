...
abun <- abun[,which(names(abun) %in% its_meta$sequencing_id)] # 1514 samples
abun <- abun[rowSums(abun)>0,] # 49966 ASVs
...
# for ASVs and samples in 3 habs of interest: 49966 ASVs, 1514 samples

culled_abun <- abun[,colSums(abun)>160] # 40 samples removed, 1474 remain
# remove ASVs with only one read
culled_abun <- culled_abun[rowSums(culled_abun)>1,] # 7 ASVs removed, 49959 remain
...
culled_abun <- culled_abun[,colnames(culled_abun) %in% its_meta$sequencing_id] # 1443 samples remain
culled_abun <- culled_abun[rowSums(culled_abun)>1,] # 49749 ASVs remain
