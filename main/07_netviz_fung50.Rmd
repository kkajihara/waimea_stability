...
```{r}
network <- readRDS("../networks/prev50_finals/outputs/fung_mb_thresh01.rds")
...
a <- ggnet2(net_test, node.size = 1, color = "#c6cdf7") + labs(title = "Fungi only, 50% prevalence", subtitle = "Batch, nlambda = 20, thresh= 0.01")

ggsave("../figures/testnetwork_full_fung_prev50_thresh01.png", width = 7, height = 6)
...
b <- ggnet2(net2, node.size = 1, color = "#c6cdf7") + labs(title = "Cross domain, 50% prevalence", subtitle = "Batch, edge confidence filter, thresh=0.03")
```
