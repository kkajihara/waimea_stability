...
test = list(filt_fung_net, filt_bact_net, filt_cross_net)
big_net_list <- c(test,
...
subnetwork <- induced.subgraph(g, vids = sample(V(g)$name, size = 719))

set.seed(134)
all_net_subgraphs <- lapply(big_net_list,
                            function(x)
                              induced.subgraph(x, sample(V(x)$name, size = 719)))


a = myrobustness_bc(all_net_subgraphs[[1]], kingdom = "Fungi")

test = lapply(all_net_subgraphs, function(x) myrobustness_bc(x, kingdom = "placeholder"))


saveRDS(test, "../intermediates/new_knockouts/new_downsamp719_all_network_bc_knockouts.rds")
```
...
regress_df$type = rep("Downsampled to 719 nodes", nrow(regress_df))
...
```
Test on habitats - downsample to top n taxa by relative abundance
...
fung_new = lapply(fung_hab_igraphs, take_top, otu_table = fung_abun, number_to_take = 918)
...
saveRDS(new_fung_igraphs, "../intermediates/habitat/fung_downsamp918_igraphs.rds")

# bact
bact_new = lapply(bact_hab_igraphs, take_top, otu_table = bact_abun, number_to_take = 918)
...
saveRDS(new_bact_igraphs, "../intermediates/habitat/bact_downsamp918_igraphs.rds")
...
equal_downsamp_cross <- lapply(new_cross_igraphs,
                            function(x)
                              induced.subgraph(x, sample(V(x)$name, size = 918)))

saveRDS(equal_downsamp_cross, "../intermediates/habitat/cross_downsamp918_igraphs.rds")
...
saveRDS(hab_bc, "../intermediates/habitat/hab_downsamp918_bc_knockouts.rds")
...
fung_robustness$habitat = c(rep("Stream", 919), 
                  rep("Terrestrial", 919), 
                  rep("Marine", 919))

bact_robustness$habitat = c(rep("Stream", 919), 
                  rep("Terrestrial", 919), 
                  rep("Marine", 919))

cross_robustness$habitat = c(rep("Stream", 919), 
                  rep("Terrestrial", 919), 
                  rep("Marine", 919))
...
color = "Category", shape = "Kingdom", title = "Stream Top 918", linetype = "Type") +
...
terr_bc_plot <- ggplot(all_terr, aes(x=removed.pct, y=comp.pct, color=kingdom, group = kingdom, linetype = type)) +
  geom_line(linewidth = 1.5) +
  labs(x="Fraction of nodes removed", y="Fractional size of largest connected component",
color = "Category", shape = "Kingdom", title = "Terrestrial Top 918", linetype = "Type") +
   scale_color_manual(values = kingdom_palette) +
  theme(legend.key = element_rect(fill="white")) +
  theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
...
marine_bc_plot <- ggplot(all_marine, aes(x=removed.pct, y=comp.pct, color=kingdom, group = kingdom, linetype = type)) +
  geom_line(linewidth = 1.5) +
  labs(x="Fraction of nodes removed", y="Fractional size of largest connected component",
color = "Category", shape = "Kingdom", title = "Marine Top 918", linetype = "Type") +
   scale_color_manual(values = kingdom_palette) +
  theme(legend.key = element_rect(fill="white")) +
  theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
...
all_aucs <- sapply(hab_bc, get_auc)


auc_df <- data.frame(kingdom = c(rep("Fungi", 3), rep("Bacteria", 3), rep("Interkingdom", 3)),
...
pl <- ggplot(auc_df, aes(x = network, y = robustness, color = habitat, fill = kingdom)) +
...
fung_bc_plot <- ggplot(fung_robustness, aes(x=removed.pct, y=comp.pct, color=habitat, group = habitat, linetype = type)) +
  geom_line(linewidth = 1.5) +
  labs(x="Fraction of nodes removed", y="Fractional size of largest connected component",
color = "Category", shape = "Kingdom", title = "Fungi Top 918", linetype = "Type") +
  scale_color_manual(values = habitat_palette) +
  theme(legend.key = element_rect(fill="white")) +
  theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
...
bact_bc_plot <- ggplot(bact_robustness, aes(x=removed.pct, y=comp.pct, color=habitat, group = habitat, linetype = type)) +
  geom_line(linewidth = 1.5) +
  labs(x="Fraction of nodes removed", y="Fractional size of largest connected component",
color = "Category", shape = "Kingdom", title = "Bacteria Top 918", linetype = "Type") +
  theme(legend.key = element_rect(fill="white")) +
  scale_color_manual(values = habitat_palette) +
  theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
...
cross_bc_plot <- ggplot(cross_robustness, aes(x=removed.pct, y=comp.pct, color=habitat, group = habitat, linetype = type)) +
  geom_line(linewidth = 1.5) +
  labs(x="Fraction of nodes removed", y="Fractional size of largest connected component",
color = "Category", shape = "Kingdom", title = "Interkingdom 900", linetype = "Type") +
  scale_color_manual(values = habitat_palette) +
  theme(legend.key = element_rect(fill="white")) +
  theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
...
fung_bc_plot_grad <- ggplot(fung_robustness_grad, aes(x=removed.pct, y=comp.pct, color=site, group = site)) +
  geom_line(linewidth = 1.5) +
  labs(x="Fraction of nodes removed", y="Fractional size of largest connected component",
color = "Category", shape = "Kingdom", title = "Fungi Top 721", linetype = "Type") +
  #scale_color_manual(values = habitat_palette) +
  theme(legend.key = element_rect(fill="white")) +
  theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
...
bact_bc_plot_grad <- ggplot(bact_robustness_grad, aes(x=removed.pct, y=comp.pct, color=site, group = site)) +
  geom_line(linewidth = 1.5) +
  labs(x="Fraction of nodes removed", y="Fractional size of largest connected component",
color = "Category", shape = "Kingdom", title = "Bacteria Top 721", linetype = "Type") +
  theme(legend.key = element_rect(fill="white")) +
  #scale_color_manual(values = habitat_palette) +
  theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
...
cross_bc_plot_grad <- ggplot(cross_robustness_grad, aes(x=removed.pct, y=comp.pct, color=site, group = site)) +
  geom_line(linewidth = 1.5) +
  labs(x="Fraction of nodes removed", y="Fractional size of largest connected component",
color = "Category", shape = "Kingdom", title = "Interkingdom 721", linetype = "Type") +
  #scale_color_manual(values = habitat_palette) +
  theme(legend.key = element_rect(fill="white")) +
  theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
