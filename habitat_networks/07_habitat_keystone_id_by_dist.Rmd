...
for (i in 1:length(fung_dat)) {
  V(fung_habitat_networks[[i]])$proportion <- apply(fung_dat[[i]], 1, function(c) sum(c!=0) / dim(fung_dat[[i]])[2])
  V(fung_habitat_networks[[i]])$relabun <- apply(fung_relabun[[i]], 1, function(b) sum(b) / dim(fung_dat[[i]])[2])
...
for (i in 1:length(bact_dat)) {
  V(bact_habitat_networks[[i]])$proportion <- apply(bact_dat[[i]], 1, function(c) sum(c!=0) / dim(bact_dat[[i]])[2])
  V(bact_habitat_networks[[i]])$relabun <- apply(bact_relabun[[i]], 1, function(b) sum(b) / dim(bact_dat[[i]])[2])
...
for (i in 1:length(cross_dat)) {
  V(cross_habitat_networks[[i]])$proportion <- apply(cross_dat[[i]], 1, function(c) sum(c!=0) / dim(cross_dat[[i]])[2])
  V(cross_habitat_networks[[i]])$relabun <- apply(cross_relabun[[i]], 1, function(b) sum(b) / dim(cross_dat[[i]])[2])
