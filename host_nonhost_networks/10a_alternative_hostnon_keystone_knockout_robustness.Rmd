...
for (i in 1:length(fung_keystone_data)) {
  net_no_key <- delete_vertices(fung_hostnon_networks[[i]], fung_keystone_data[[i]]$name)
...
ggsave("../figures/finals/hostnon/alternative_fung_keystone_removal_robustness_by_hostnon.pdf", width=12, height=6.75)

ggsave("../figures/finals/hostnon/alternative_fung_keystone_removal_robustness_by_hostnon.png", width=12, height=6.75)
...
for (i in 1:length(bact_keystone_data)) {
  net_no_key <- delete_vertices(bact_hostnon_networks[[i]], bact_keystone_data[[i]]$name)
...
# ggsave("../figures/hostnon/one_bact_keystone_removal_rob_plot.png", bact_key_rob_plots[[1]], width=10, height=6.75)
...
ggsave("../figures/finals/hostnon/alternative_bact_keystone_removal_robustness_by_hostnon.pdf", width=12, height=6.75)

ggsave("../figures/finals/hostnon/alternative_bact_keystone_removal_robustness_by_hostnon.png", width=12, height=6.75)
...
for (i in 1:length(cross_keystone_data)) {
  net_no_key <- delete_vertices(cross_hostnon_networks[[i]], cross_keystone_data[[i]]$name)
...
ggsave("../figures/finals/hostnon/alternative_cross_keystone_removal_robustness_by_hostnon.pdf", width=12, height=6.75)

ggsave("../figures/finals/hostnon/alternative_cross_keystone_removal_robustness_by_hostnon.png", width=12, height=6.75)
