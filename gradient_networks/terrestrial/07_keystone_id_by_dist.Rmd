...
for (i in 1:length(fung_dat)) {
  V(fung_gradient_networks[[i]])$proportion <- apply(fung_abun[[i]], 1, function(c) sum(c!=0) / dim(fung_abun[[i]])[2])
...
for (i in 1:length(bact_dat)) {
  V(bact_gradient_networks[[i]])$proportion <- apply(bact_abun[[i]], 1, function(c) sum(c!=0) / dim(bact_abun[[i]])[2])
  V(bact_gradient_networks[[i]])$relabun <- apply(bact_relabun[[i]], 1, function(b) sum(b) / dim(bact_abun[[i]])[2])
...
for (i in 1:length(cross_dat)) {
  V(cross_gradient_networks[[i]])$proportion <- apply(cross_abun[[i]], 1, function(c) sum(c!=0) / dim(cross_abun[[i]])[2])
  V(cross_gradient_networks[[i]])$relabun <- apply(cross_relabun[[i]], 1, function(b) sum(b) / dim(cross_abun[[i]])[2])
