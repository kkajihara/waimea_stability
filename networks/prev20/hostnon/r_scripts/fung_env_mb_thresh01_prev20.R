...
reg = makeRegistry(file.dir = 'batch_registry1', seed = 1)

f_abun <- readRDS("~/hynson_koastore/kaciekaj/waimea_current/intermediates/hostnon/fung_hostnon_abun_for_networks.rds")[["Free-living"]]
...
saveRDS(singledom_net, "~/hynson_koastore/kaciekaj/waimea_current/networks/prev20/hostnon/outputs/fung_nonhost_network_p20_mb_thresh01.rds")
