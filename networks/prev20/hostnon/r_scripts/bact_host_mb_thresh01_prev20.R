...
reg = makeRegistry(file.dir = 'batch_registry16', seed = 1)

b_abun <- readRDS("~/hynson_koastore/kaciekaj/waimea_current/intermediates/hostnon/bact_hostnon_abun_for_networks.rds")[["Host-associated"]]
...
saveRDS(singledom_net, "~/hynson_koastore/kaciekaj/waimea_current/networks/prev20/hostnon/outputs/bact_host_network_p20_mb_thresh01.rds")
