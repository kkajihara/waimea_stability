...
#bargs <- list(thresh=1e-5)

bact_network <- spiec.easi(data, method='glasso', scr=TRUE)

saveRDS(bact_network, "~/cmaiki_lts/kaciekaj/waimea/networks/prev20/gradient/outputs/riverine/bact_entrance_network_glasso.rds")
# 
# 
# 
# ######## cross domain
