...
reg = makeRegistry(file.dir = 'batch_registry2', seed = 1)
...
saveRDS(singledom_net, "~/cmaiki_lts/kaciekaj/waimea/networks/prev20/outputs/downsampled_fung_prev20_mb_thresh05_with_dummy.rds")
