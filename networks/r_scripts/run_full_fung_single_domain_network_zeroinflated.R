...
abun <- readRDS("~/cmaiki_lts/kaciekaj/waimea/intermediates/no_singlesampASVs_fung_asv_table.rds")
abun <- t(abun)
...
saveRDS(single_dom_net, "~/cmaiki_lts/kaciekaj/waimea/networks/outputs/full_fung_network_zeroinf_filtered.rds?")
