...
setwd("~/cmaiki_lts/kaciekaj/waimea/networks/bact_prev_test/r_scripts/")
...
saveRDS(crossdom_net, "~/cmaiki_lts/kaciekaj/waimea/networks/prev50_finals/crossdom_mb_nlambda50.rds")
